...
console.log('%cMatrix Font Editor \n%cFor converting 8-bit variable-width characters to JSON', 'font-family:"Montserrat",sans-serif;font-weight:600;font-size:20px;color:#f58220;', 'font-family:"Montserrat",sans-serif;font-weight:600;font-size:20px;color:#000;'); //  ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
//  Helper Functions
//  ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
...
function parseGlyph(canvas) {
  ...
  for (let pixelX = 0; pixelX < canvas.width; pixelX++) {
    ...
    for (let pixelY = canvas.height - 1; pixelY >= 0; pixelY--) {
      // image rows
...
function drawGlyph(canvas, glyphData) {
  let offset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  let canvasContext = canvas.getContext('2d');

  for (let pixelX = 0; pixelX < glyphData.length; pixelX++) {
    // image columns
    let column = '';
...
function saveFont() {
  ...
  let outputFont = {}; // clear font from localStorage
...
function downloadJson() {
  let blob = new Blob([localStorage.myFont], {
    type: 'text/plain'
  });
